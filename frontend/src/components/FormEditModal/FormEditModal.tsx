...
export const FormEditModal: React.FC<CreateModalProps> = ({ onCloseEdit, id }) => {
    ...
    return (
        <form className={styles.formCreateModal}>
            <div className={styles.modalCreateLeftSide}>
                ...
                <button onClick={onCloseEdit} className={styles.buttonClose}>
            ...
            <div className={styles.modalCreateRigthSide}>
                ...
                <button type="submit" onClick={() => editPet(id)} className={styles.buttonCadastrar}>
