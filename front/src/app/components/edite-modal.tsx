...
const EditeModal = ({ openClosed }: IProps) => {
  ...
  return (
    <dialog
      ...
      className="fixed top-52 flex my-2  p-4 flex-col border-blue-600 justify-center rounded-md w-full border-2 md:w-2/3 lg:w-1/2 xl:w-2/5 h-auto md:p-8 lg:p-12" open>
      <div className="flex items-center justify-between m-2 md:m-2">
        <div className="flex items-center gap-2 md:gap-4">
          <Image src={editeIcon2} className="w-12 h-12 md:w-16 md:h-16" alt="editar" />
          <h1 className="text-slate-50 text-lg md:text-xl">Editar</h1>
        </div>
        <button
          onClick={openClosed}
          >
