...
var BaseDatabase_1 = require("../data/base/BaseDatabase");
var PetBusiness_1 = require("../business/PetBusiness");
var PetDatabase_1 = require("../data/PetDatabase");
var idGenerator_1 = require("../services/idGenerator");
var PetController = /** @class */ (function () {
    function PetController() {
    }
    PetController.prototype.registerPet = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PetController.PetBusiness.registerPet(input)];
                    case 1:
                        _a.sent();
    ...
    ;
    PetController.prototype.getPets = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var pets, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, PetController.PetBusiness.getAllPet()];
                    case 1:
                        pets = _a.sent();
                        res.status(200).send({
                            pets: pets
                    ...
                    case 2:
                        error_2 = _a.sent();
                        res.status(400).send({
                            error: error_2.sqlMessage || error_2.message
                        });
                        return [3 /*break*/, 3];
                    case 3: return [4 /*yield*/, BaseDatabase_1.BaseDatabase.destroyConnection()];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PetController.PetBusiness.updatePet(id, input)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, PetController.PetBusiness.deletePet(id)];
                    case 1:
                        _a.sent();
